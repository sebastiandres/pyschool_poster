...
# Pack all buttons
button_dict = {
    "problem": problem_button_dict,
    "events": events_button_dict,
    "objective": objective_button_dict,
    "results": results_button_dict,
    "team": team_button_dict,
    "acknowledgement": acknowledgement_button_dict,
    "tech_stack": tech_stack_button_dict,
    "replicate": replicate_button_dict,
    "photos": photos_button_dict,
    "links": links_button_dict
}
...
events_dict = {
    "English": """
During 2024, with the support of Python Chile, Python Software Foundation and DUOC UC, we developed the content and site, and perform 3 events of PySchool. 
ON X, we had Y students.
""",
    "Español": """
...
acknowledgement_dict = {
    "English": """
We would like to thank Python Chile, Python Software Foundation and DUOC UC for their support and collaboration in the development of PySchool.
""",
    "Español": """
Agradecimiento a Python Chile, Python Software Foundation y DUOC UC por su apoyo y colaboración en el desarrollo de PySchool.
"""
}
